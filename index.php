	...
	<div class="iar-aboutContent" style="background-image: url(images/small_shape.png); background-color: #1c335f">
		...
		<div class="description">
			...
			<p>COER University of Engineering is an innovative modern university, which offers
				professionally focused undergraduate and postgraduate degree programs. COER was established in ####..
			</p>
			</p>
		</div>
		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-12 iar-admissionOpenContent-col">
				<div class="iar-admissionOpenContent">
					...
					<div class="description">
						<p>The basic objective of the COER admission policy is to identify meritorious candidates for
							admission to various programs without any prejudice to their caste, creed, religion,
							language, ethnicity, gender and disability.</p>
						<p>The admissions will be on merit basis. 60% in the latest qualifying examination is set as
							Merit for the admission to UG and PG Programs.</p>
					</div>
					<div class="applyNow">
					...
					<div class="btn">
						<a href="#">
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
								version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 14 15.3" xml:space="preserve">
								<path class="st0"
									d="M6.1,15.2C6,15,6,14.8,6.1,14.7c0,0,0,0,0,0l7.1-7.1L6.1,0.6C6,0.4,6,0.2,6.1,0.1l0,0l0,0l0,0l0,0l0,0l0,0  c0,0,0,0,0,0l0,0C6.3,0,6.5,0,6.6,0.1l7.3,7.3c0.1,0.1,0.1,0.3,0,0.5c0,0,0,0,0,0l-7.3,7.3c0,0,0,0,0,0l0,0l0,0  c-0.1,0-0.1,0.1-0.2,0.1C6.2,15.3,6.2,15.2,6.1,15.2z">
								</path>
								<path class="st0"
									d="M0.1,15.2C0,15,0,14.8,0.1,14.7c0,0,0,0,0,0l7.1-7.1L0.1,0.6C0,0.4,0,0.2,0.1,0.1c0,0,0,0,0,0  C0.2,0,0.4,0,0.6,0.1c0,0,0,0,0,0l7.3,7.3C8,7.5,8,7.7,7.9,7.9c0,0,0,0,0,0l-7.3,7.3c0,0,0,0,0,0c0,0,0,0,0,0l0,0  c-0.1,0-0.1,0.1-0.2,0.1C0.2,15.3,0.2,15.2,0.1,15.2L0.1,15.2z">
								</path>
							</svg>
						</a>
					</div>
	...
	<div class="container">
		<div class="row">
			...
			<ul class="nav nav-tabs basic icon_top" role="tablist">
				<li class="nav-item">
					<a class="nav-link active" href="#campus-life" data-bs-toggle="tab" data-bs-target="#campus-life"
						role="tab" aria-controls="campus-life" aria-selected="true">
						<img class="img-fluid" src="images/scholarship.png" alt="" />campus-life</a>
				</li>
				<li class="nav-item">
					<a class="nav-link " href="#infrastructure-facilities" data-bs-toggle="tab"
						data-bs-target="#infrastructure-facilities" role="tab" aria-controls="infrastructure-facilities"
						aria-selected="true">
						<img class="img-fluid" src="images/book-1.png" alt="" />infrastructure-facilities</a>
				</li>
				<li class="nav-item">
					<a class="nav-link " href="#start-up" data-bs-toggle="tab" data-bs-target="#start-up" role="tab"
						aria-controls="start-up" aria-selected="true">
				...
				<div class="tab-pane active" id="campus-life" role="tabpanel">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 co-12 iar-tabContent-col">
							...
							<div class="description">
								<p>During their tenure at COER, students are engaged through various on and off-campus
									activities to help explore their potential an learn about the practical work
									environment. Also, they are encouraged to actively participate in various
									competitions and events throughout the year.</p>
								<p>The COER campus is a diverse, sociable community, where imaginations thrives and
									ambitions are realized with right guidance.</p>
							</div>
							<div class="applyNow">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 co-12">
							<div class="libraryGalleryImg-slider">
								<div class="slick_slider">
									<div>
										<img src="images/Infrastructure-Facilities-1.jpg" class="img-fluid"
											alt="Slider Image" />
									</div>
									<div>
										<img src="images/Infrastructure-Facilities-2.jpg" class="img-fluid"
											alt="Slider Image" />
									</div>
									<div>
										<img src="images/Infrastructure-Facilities-3.jpg" class="img-fluid"
											alt="Slider Image" />
									</div>
								</div>
				...
				<div class="tab-pane " id="start-up" role="tabpanel">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 co-12 iar-tabContent-col">
							...
							<div class="description">
								<p>At COER, we have started the COER Startup and Entrepreneurship Cell to promote and
									accelerate the innovation and translate them successfully.</p>
								<p>The main aim to start this cell at COER is to nurture and support the young
									generation for entrepreneurship and promote the government initiative of Student
									Startup and Innovation Policy(SSIP), Atal Innovation Mission, Startup India, Startup
									Gujarat, Skill India and Make in India.</p>
							</div>
							<div class="applyNow">
								<a href="#" class="applyNowBtn">Know More</a>
							</div>
					...
					<div class="arrows">
						<span class="ticker-prev slick-arrow">
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
								version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 14 15.3" xml:space="preserve">
								<path class="st0"
									d="M7.9,0.1C8,0.2,8,0.4,7.9,0.6c0,0,0,0,0,0L0.8,7.6l7.1,7.1C8,14.8,8,15,7.9,15.2l0,0l0,0l0,0l0,0l0,0l0,0  c0,0,0,0,0,0l0,0c-0.1,0.1-0.3,0.1-0.4,0L0.1,7.9C0,7.7,0,7.5,0.1,7.4c0,0,0,0,0,0l7.3-7.3c0,0,0,0,0,0l0,0l0,0C7.5,0,7.6,0,7.7,0  C7.8,0,7.8,0,7.9,0.1z">
								</path>
								<path class="st0"
									d="M13.9,0.1c0.1,0.1,0.1,0.3,0,0.5c0,0,0,0,0,0L6.8,7.6l7.1,7.1c0.1,0.1,0.1,0.3,0,0.5c0,0,0,0,0,0  c-0.1,0.1-0.3,0.1-0.5,0c0,0,0,0,0,0L6.1,7.9C6,7.7,6,7.5,6.1,7.4c0,0,0,0,0,0l7.3-7.3c0,0,0,0,0,0c0,0,0,0,0,0l0,0  C13.5,0,13.6,0,13.7,0C13.8,0,13.8,0,13.9,0.1L13.9,0.1z">
								</path>
							</svg>
						</span>
