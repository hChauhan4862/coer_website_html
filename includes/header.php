            ...
            <nav class="navbar navbar-expand-lg custom_navbar navbar-dark">
                ...
                <div class="main_logo">
                    <div class="custom-logo-link">
                        <img alt="LOGO" class="img-fluid main-logo" nitro-lazy-empty="" id="main-logo"
                ...
                <div class="collapse navbar-collapse menu_bar" id="navbarSupportedContent">
                    <ul class="ml-auto navbar-nav ms-auto">
                        ...
                        <li class="menu-item menu-item-has-children nav-item">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="menu-item nav-item"><a href="#" class="dropdown-item">Master of
                                        Technology(CSE)</a></li>
                                <li class="menu-item nav-item"><a href="#" class="dropdown-item">Master of Computer
                                ...
                                <li class="menu-item nav-item"><a href="#" class="dropdown-item">Infrastructure and
                                        Facilities</a></li>
                                <li class="menu-item nav-item"><a href="#" class="dropdown-item">Academic Calendar</a>
                                </li>
                        ...
                        <li class="menu-item menu-item-has-children nav-item">
                            <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                class="dropdown-toggle nav-link">Examination</a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="menu-item menu-item-has-children quick-links-menu">
                            <a class="nav-link" href="javascript:void(0)" id="navbarDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">More Links</a>
                            <ul class="dropdown-menu">
